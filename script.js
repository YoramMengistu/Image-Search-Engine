...
const downloadImgBtn = lightbox.querySelector(".bi-download");
const closeImgBtn = lightbox.querySelector(".bi-x-lg");

// API key, paginations, searchTerm variables
const apiKey = "ORVyYQCHxbJCE6F4ODcwhEzyYNtMrsCF9dp5RxK97Wl3WwbYALWK97WU";
const perPage = 15;
let currentPage = 1;
let searchTerm = null;
